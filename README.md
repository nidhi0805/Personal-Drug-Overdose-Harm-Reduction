...
- Preprocess the text:Tokenization, Lemmatization, Stopword Removal.
- Extract keywords using YAKE.
- Sentiment Analysis: Classify posts into Positive, Negative, Neutral using VADER.
- Trend Analysis: Aggregate yearly mentions for different opioids.
